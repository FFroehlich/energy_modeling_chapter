...
\$\mathcal{L}\_l \textless{} \mathcal{U}\_l \$ and
...
\PY{k}{def} \PY{n+nf}{extend\PYZus{}model}\PY{p}{(}\PY{p}{)}\PY{p}{:}
    ...
    \PY{n}{Parameter}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{ep\PYZus{}RAF\PYZus{}RAF\PYZus{}mod\PYZus{}RASstategtp\PYZus{}double\PYZus{}ddG}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
    \PY{n}{Parameter}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{bind\PYZus{}RASstategtp\PYZus{}RAF\PYZus{}Ea}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
    \PY{n}{Parameter}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{bind\PYZus{}RASstategtp\PYZus{}RAF\PYZus{}dG}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
    \PY{n}{Parameter}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{bind\PYZus{}RASstategtp\PYZus{}RAF\PYZus{}phi}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
    \PY{n}{Parameter}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{catalyze\PYZus{}RAF\PYZus{}RAFrafiNone\PYZus{}MEK\PYZus{}p\PYZus{}kcat}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
    \PY{n}{Parameter}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{catalyze\PYZus{}RAFrafiNone\PYZus{}MEK\PYZus{}p\PYZus{}kcat}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
    \PY{n}{Parameter}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{catalyze\PYZus{}MEKmekiNone\PYZus{}phosphop\PYZus{}ERK\PYZus{}p\PYZus{}kcat}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
    \PY{n}{Parameter}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{synthesize\PYZus{}ERKphosphop\PYZus{}DUSP\PYZus{}ERK\PYZus{}gexpslope}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
    \PY{n}{Parameter}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{synthesize\PYZus{}ERKphosphop\PYZus{}DUSP\PYZus{}kdeg}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
    \PY{n}{Parameter}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{synthesize\PYZus{}ERKphosphop\PYZus{}DUSP\PYZus{}ERK\PYZus{}kM}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
    \PY{n}{Parameter}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{inhibition\PYZus{}ERKphosphop\PYZus{}RAS\PYZus{}kM}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
    \PY{n}{Parameter}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{catalyze\PYZus{}PP2A\PYZus{}MEK\PYZus{}u\PYZus{}kcatr}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
    \PY{n}{Parameter}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{catalyze\PYZus{}DUSP\PYZus{}ERK\PYZus{}u\PYZus{}kcatr}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
    \PY{n}{Parameter}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{activation\PYZus{}RAS\PYZus{}kcat}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}

    \PY{n}{Parameter}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{RAS\PYZus{}0}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
    \PY{n}{Parameter}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{MEK\PYZus{}0}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
    \PY{n}{Parameter}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{ERK\PYZus{}0}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
    \PY{n}{Parameter}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{EGF\PYZus{}0}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
    \PY{n}{Parameter}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{DUSP\PYZus{}eq}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}

    \PY{n}{Expression}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Ea0\PYZus{}bind\PYZus{}RASstategtp\PYZus{}RAF}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} 
    ...
    \PY{n}{Rule}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{RASgtp\PYZus{}and\PYZus{}BRAF\PYZus{}bind\PYZus{}and\PYZus{}dissociate}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} 
         ...
         \PY{n}{bind\PYZus{}RASstategtp\PYZus{}RAF\PYZus{}phi}\PY{p}{,} \PY{n}{Ea0\PYZus{}bind\PYZus{}RASstategtp\PYZus{}RAF}\PY{p}{,} \PY{n}{energy}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}
...
\cite{2754712/INKV577L}\cite{2754712/FMD3RVCR}. Yet, the thermodynamic
...
packages/amici/parameter\_mapping.py:193: RuntimeWarning: The following problem
parameters were not used: \{'MEK\_0', 'RAS\_0', 'bind\_RASstategtp\_RAF\_phi',
'ERK\_0', 'bind\_RAFi\_RAF\_phi', 'bind\_RAF\_RAF\_phi', 'CRAF\_0', 'BRAF\_0'\}
